...
router.post('/', async (req,res)=>{
  ...
  const mailOptions= {
    ...
    <p style="text-align: left; margin:30px 0;">
      <a href="https://recipes-api-amber.vercel.app/confirm?token=${token}"
    ...
    <p style="font-size: 18px; color: #888;">
      <a href="https://recipes-api-amber.vercel.app/unsubscribe?token=${token}" style="color: #888;">Unsubscribe</a> |
    </p>
  </div>
    `
  }
